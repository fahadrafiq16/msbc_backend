...
router.post('/proefles-email', async (req, res) => {
    const { data } = req.body;
    ...
    const mailOptions = {
        ...
        subject: 'Aanmelding proefles is gelukt. - Marlon',
        html: `
          <div style="border: 2px solid #F04D17; padding: 20px; font-size:15px; background-color: #f9f9f9; border-radius: 10px; font-family: Arial, sans-serif; color: #333;">
                    ...
                    <div style="padding: 20px; background-color: #ffffff; border-radius: 5px;">
                        <p><strong>Onderwerp proefles</strong> Aanmelding <em>${trainingsoptions}</em></p>
                        <p><strong>Beste ${voornaam},</strong></p>
                        <p>Welkom bij My Summerbody Club!</p>
                        <p>Bedankt, we hebben je aanvraag voor een proefles ${trainingsoptions} goede orde ontvangen, je krijgt zo snel mogelijk een bevestiging of je gekozen tijdstip tijdstip goed is gekeurd.</p>
                    </div>
                    ...
                    <div style="margin: 20px 0; padding: 15px; background-color: #f3f3f3; border-radius: 5px; border-left: 5px solid #F04D17;">
                        ...
                        <p><strong>Proefles dag:</strong> ${trainingdays}</p>
                        <p><strong>Verzoektijd:</strong> ${timepreference}</p>
                    </div>
        `,
    };
